	...
	: m_pGameInstance(CGameInstance::GetInstance())
{
	...
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_FILLMODE, D3DFILL_WIREFRAME);*/
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_CULLMODE, D3DCULL_CW);*/	
	///*DirectX11 : */ m_pContext->RSSetState();

	///* DepthStencilState : D3D11_DEPTH_STENCIL_DESC*/
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_ZENABLE, TRUE);*/
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_ZWRITEENABLE, TRUE);*/
	///*DirectX11 : */ m_pContext->OMSetDepthStencilState();

	///* BlendState : D3D11_BLEND*/
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_ALPHABLENDENABLE, TRUE);*/
	///*DirectX9 : m_pGraphic_Device->SetRenderState(D3DRS_ALPHATESTENABLE, TRUE);*/
	///*DirectX11 : */ m_pContext->OMSetBlendState();
}
