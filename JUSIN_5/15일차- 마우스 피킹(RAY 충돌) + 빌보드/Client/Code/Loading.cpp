...
_uint CLoading::Loading_ForStage(void)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_GreenSlimeTexture", CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Idle/GreenSlime%d.png", TEX_NORMAL, 4)), E_FAIL);
