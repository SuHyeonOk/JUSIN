...
void CMathUtils::Transform(const XMFLOAT3 & v, const XMFLOAT4X4 & m, XMFLOAT4 & result)
{
	XMVECTOR v1 = XMLoadFloat3(&v);
	XMMATRIX M = XMLoadFloat4x4(&m);
...
void CMathUtils::Transform(const XMFLOAT3 * varray, size_t count, const XMFLOAT4X4 & m, XMFLOAT4 * resultArray)
{
	XMMATRIX M = XMLoadFloat4x4(&m);
