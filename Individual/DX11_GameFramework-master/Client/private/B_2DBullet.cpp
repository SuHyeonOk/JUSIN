...
void CB_2DBullet::Late_Tick(_double TimeDelta)
{
	...
	if (1 < m_dBullet_TimeAcc)
	{
		...
		{
			if (0 == m_tBulletInfo.iCircle_Color)		// 파란색
				CEffect_Manager::GetInstance()->Effect_Star3Count_Create(_float3(f4MyPos.x, f4MyPos.y, f4MyPos.z), _float3(0.09f, 0.46f, 0.76f));
			else if (1 == m_tBulletInfo.iCircle_Color)	// 빨간색
				CEffect_Manager::GetInstance()->Effect_Star3Count_Create(_float3(f4MyPos.x, f4MyPos.y, f4MyPos.z), _float3(0.89f, 0.25f, 0.14f));
			else if (2 == m_tBulletInfo.iCircle_Color)	// 노란색
				CEffect_Manager::GetInstance()->Effect_Star3Count_Create(_float3(f4MyPos.x, f4MyPos.y, f4MyPos.z), _float3(1.0f, 0.67f, 0.0f));
		}
