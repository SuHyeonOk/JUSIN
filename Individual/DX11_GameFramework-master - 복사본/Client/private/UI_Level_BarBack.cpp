...
HRESULT CUI_Level_BarBack::Render()
{
	...
	if(1000 < CObj_Manager::GetInstance()->Get_Current_Player().iCoin)
	...
	else if(100 < CObj_Manager::GetInstance()->Get_Current_Player().iCoin)
		...
		pGameInstance->Render_Font(TEXT("Font_Comic"), szCount, _float2(190.f, 113.f), 0.f, _float2(0.33f, 0.3f), XMVectorSet(1.0f, 0.84f, 0.0f, 1.f));
